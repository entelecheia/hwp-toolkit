#!/bin/bash
# HWP Toolkit - Dependency Setup Script for Linux
# Installs all required packages for HWP/HWPX processing

set -e

echo "=== HWP Toolkit: Installing Dependencies (Linux) ==="

# Python packages
echo "[1/3] Installing Python packages..."
sudo pip3 install olefile pyhwp pyhwp2md python-hwpx gethwp weasyprint markdown 2>&1 | tail -10
